...
open (unit = 14, file = "coka.csv", status="old", action = "read")
...
open (unit = 19, file = "Greska.csv")
  ...
  read (14,*) god(i),mesec(i),dan(i),sat(i),padavine(i),battery(i),leafWet(i),tsr(i),tmin(i),tmax(i),rvl(i),twsr(i),&
              twmin(i),eto(i)
